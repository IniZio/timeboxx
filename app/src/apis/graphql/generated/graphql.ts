...
export enum StrawberryTaskStatus {
  Backlog = 'BACKLOG',
  Cancelled = 'CANCELLED',
  Done = 'DONE',
...
export type Task = {
  ...
  status?: Maybe<StrawberryTaskStatus>;
...
export type TasksScreenQuery = { __typename?: 'Query', tasks: Array<{ __typename?: 'Task', id: string, description?: string | null, endTime?: any | null, startTime?: any | null, title?: string | null, status?: StrawberryTaskStatus | null }> };
