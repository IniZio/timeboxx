...
export type CreateTaskMutation = { __typename?: 'Mutation', createTask: { __typename?: 'TaskType', id: string, title: string | null, status: TaskStatus | null } };

export type TaskList_TaskFragmentFragment = { __typename?: 'TaskType', id: string, title: string | null, status: TaskStatus | null };

export type TasksScreenQueryVariables = Exact<{ [key: string]: never; }>;


export type TasksScreenQuery = { __typename?: 'Query', tasks: Array<{ __typename?: 'TaskType', id: string, title: string | null, status: TaskStatus | null }> };
...
export type UpdateTaskMutation = { __typename?: 'Mutation', updateTask: { __typename?: 'TaskType', id: string, title: string | null, status: TaskStatus | null } };
